...
<a id="edit-mode-btn" href="?" class="floating-edit-btn">&#127881; Make Your Own friend_r Profile &raquo;</a>

<!-- Optional email modal (shown on Preview/Share, only once per device) -->
<div id="email-gate" class="intro-modal" hidden>
  <div class="intro-modal-card">
    <div class="intro-eyebrow">From the maker</div>
    <h2>Did you enjoy this? <span class="wave">&#127881;</span></h2>
    <p>I make weird, nostalgic internet projects when I get bored.
       Drop your email if you'd like a heads-up when I build the next one &mdash;
       I'll keep in touch. No spam, just the cool stuff.</p>
    <form id="email-gate-form">
      <input type="email" name="email" placeholder="you@example.com">
      <label class="optin-label">
        <input type="checkbox" name="opt_in" value="1" checked>
        <span>Yes, send me occasional emails when there's something new from VCFY.</span>
      </label>
      <button type="submit" class="btn btn-primary intro-enter">
        Keep me posted &raquo;
      </button>
      <button type="button" id="email-skip-btn" class="btn-link-skip">
        No thanks, just continue
      </button>
      <div class="email-gate-error" id="email-gate-error" hidden></div>
    </form>
    <p class="intro-disclaimer">
      Won't share your email. Unsubscribe anytime. Fan-made recreation for entertainment only.
